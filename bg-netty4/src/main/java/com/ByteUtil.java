...
public class ByteUtil {
    ...
    public static byte[] toBase64Decode(String bigPicBase64){
        Base64.Decoder decoder = Base64.getDecoder();
        byte[] decodePic = decoder.decode(bigPicBase64);
        return decodePic;
    }
...
//        String file = "d:\\1.jpg";
//        String pic = FileUtil.readImgFile(file);
//        System.out.println(pic);
//        byte[] bytes = toBase64Decode(pic);
//        for(byte b:bytes){
//            System.out.print(b);
//        }
    }
